...
使用 Python 制作的图形化（GUI）库 **对比目前市面上的成熟软件没有任何优势**，**并且可能存在很多问题**。由希望Windows的hh开发，本人项目前均有“xw”作为前缀
...
```
git clone https://github.com/xwWindowsdhh/xwgui.git
cd xwgui
```
...
3. 提交更改（git commit -m 'Add some amzing feature'）
...
项目代办（TODO）请查看[TODO.md](.github/TODO.md)
...
大部分问题与建议可以通过[GitHub Issues](https://github.com/xwWindowsdhh/xwgui/issues) 提交

其他联系方式：

邮箱：<xwwindowsdhh@gmail.com>

QQ：3685762521

微信：HopJOka

bilibili：[希望Windows的hh的个人主页](https://space.bilibili.com/1323975625?spm_id_from=333.1007.0.0)
